...
CREATE POLICY IF NOT EXISTS "Users can insert their products"
ON public.products FOR INSERT TO authenticated
WITH CHECK (artisan_id = auth.uid());

-- Owners can update/delete their products
CREATE POLICY IF NOT EXISTS "Owners can update their products"
ON public.products FOR UPDATE TO authenticated
USING (artisan_id = auth.uid());

CREATE POLICY IF NOT EXISTS "Owners can delete their products"
...
CREATE POLICY IF NOT EXISTS "Users can upload their product images"
